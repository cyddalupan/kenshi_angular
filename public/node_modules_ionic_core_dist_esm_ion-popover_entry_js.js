"use strict";
(self["webpackChunktoybits_pwa_skeleton"] = self["webpackChunktoybits_pwa_skeleton"] || []).push([["node_modules_ionic_core_dist_esm_ion-popover_entry_js"],{
  ...
  switch (triggerAction) {
    case 'hover':
      ...
      triggerCallbacks = [{
        eventName: 'mouseenter',
        callback: function () {
          var _ref = (0,_var_www_pwa_toybits_cloud_angular_skeleton_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev) {
            ev.stopPropagation();
            if (hoverTimeout) {
...
const configureKeyboardInteraction = popoverEl => {
  const callback = /*#__PURE__*/function () {
    var _ref2 = (0,_var_www_pwa_toybits_cloud_angular_skeleton_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev) {
      var _a;
...
const Popover = class {
  ...
  presentFromTrigger(_x3) {
    var _this = this;
    return (0,_var_www_pwa_toybits_cloud_angular_skeleton_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (event, focusDescendant = false) {
  ...
  dismiss(_x4, _x5) {
    var _this3 = this;
    return (0,_var_www_pwa_toybits_cloud_angular_skeleton_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (data, role, dismissParentPopover = true) {
